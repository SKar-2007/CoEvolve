...
DOCKER_CONTAINERS_RUNNING = Gauge(
    "coevolve_docker_containers_running", "Number of active sandbox containers"
)
...
JUDGE_EVALUATION_TIME = Histogram(
    "coevolve_judge_evaluation_seconds", "Hybrid judge execution time"
)
